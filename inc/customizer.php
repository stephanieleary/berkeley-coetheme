...
function berkeley_customizer_register() {
	...
	$wp_customize->add_section( 'berkeley-settings', array(
		'description' => __( 'You may upload a header background image here.<br /><br />The default image is <strong>1200 pixels wide and 235 pixels tall</strong>.<br /><br />To upload an image to replace your site title instead, see the Header Image section of the Customizer.', 'beng' ),
