...
function berkeley_widget_class_form_extend( $instance, $widget ) {
...
add_filter( 'widget_update_callback', 'berkeley_widget_class_update', 10, 2 );

function berkeley_widget_class_params( $params ) {
...
add_filter( 'dynamic_sidebar_params', 'berkeley_widget_class_params' );